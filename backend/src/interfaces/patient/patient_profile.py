...
################################################################################
## Form generated from reading UI file 'patient_profileWVRZXI.ui'
##
...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.gender_dropbox = QComboBox(self.widget)
        self.gender_dropbox.addItem("")
        self.gender_dropbox.addItem("")
        self.gender_dropbox.setObjectName(u"gender_dropbox")

        self.verticalLayout.addWidget(self.gender_dropbox)
...
"")
    ...
    def retranslateUi(self, Frame):
        ...
        self.label.setText(QCoreApplication.translate("Frame", u"GENDER", None))
        self.gender_dropbox.setItemText(0, QCoreApplication.translate("Frame", u"MALE", None))
        self.gender_dropbox.setItemText(1, QCoreApplication.translate("Frame", u"FEMALE", None))

        self.label_2.setText(QCoreApplication.translate("Frame", u"CONTACT NUMBER", None))
        self.admin_profile_title.setText(QCoreApplication.translate("Frame", u"PATIENT PROFILE", None))
