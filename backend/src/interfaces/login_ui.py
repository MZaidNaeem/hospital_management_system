...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.login_as_lable = QLabel(self.verticalLayoutWidget)
        self.login_as_lable.setObjectName(u"login_as_lable")

        self.verticalLayout_5.addWidget(self.login_as_lable)

        self.login_as_input = QComboBox(self.verticalLayoutWidget)
        ...
        self.error_label = QLabel(self.verticalLayoutWidget)
        ...
        self.title_label.setGeometry(QRect(420, 10, 511, 71))
        font = QFont()
