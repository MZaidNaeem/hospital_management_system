...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.admin_branch_name_input = QLineEdit(self.widget_2)
        self.admin_branch_name_input.setObjectName(u"admin_branch_name_input")

        self.verticalLayout_2.addWidget(self.admin_branch_name_input)
        ...
        self.admin_contact_number_input = QLineEdit(self.widget_2)
        self.admin_contact_number_input.setObjectName(u"admin_contact_number_input")
