...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.verticalLayout.addWidget(self.admin_my_profile)
        ...
        self.verticalLayout.addWidget(self.admin_mange_admins)
        ...
        self.verticalLayout.addWidget(self.admin_manage_patients)
        ...
        self.verticalLayout.addWidget(self.admin_manage_doctors)
        ...
        self.verticalLayout.addWidget(self.admin_manage_branches)
        ...
        self.verticalLayout.addWidget(self.admin_manage_rooms)
